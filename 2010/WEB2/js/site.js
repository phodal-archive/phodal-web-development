...
(function($){
      ...
      _initMouseHandling:function(){
        ...
        var handler = {
          moved:function(e){
            ...
            }else if ($.inArray(nearest.node.name, ['arbor.js','code','docs','demos','new']) >=0 ){
    ...
    var that = {
      ...
      update:function(){
        ...
        switch (_path){
          case '':
          case '/':
          dom.find('p').text('a wonderful and createful social')
  ...
  $(document).ready(function(){
    ...
    var theUI = {
      nodes:{"墨颀":{color:"red", shape:"dot", alpha:1}, 
			 ...
			 "部门简介":{color:CLR.branch, shape:"dot", alpha:1},
			 hello:{color:CLR.demo, alpha:0, link:'/halfviz'},
            },
      edges:{
        "墨颀":{
          demos:{length:.8},
